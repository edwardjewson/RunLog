...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { comment: @training.comment, date: @training.date, distance: @training.distance, time: @training.time }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { comment: @training.comment, date: @training.date, distance: @training.distance, time: @training.time }
    assert_redirected_to training_path(assigns(:training))
  end
